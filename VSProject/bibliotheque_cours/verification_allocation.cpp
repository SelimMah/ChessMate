...
// Configuration si on veut afficher les erreur à la console et si on veut terminer l'exécution sur une erreur de désallocation.  
// Définir ou non les macros suivantes.
